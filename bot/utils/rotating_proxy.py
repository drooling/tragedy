...
class Proxies: # https://www.alexbilz.com/post/rotating-free-elite-proxies-in-python/
    ...
    def scrape(self):
        while True:
            try:
                ...
                response = requests.get("https://checkip.amazonaws.com/", proxies=proxy, timeout=7)
                break
